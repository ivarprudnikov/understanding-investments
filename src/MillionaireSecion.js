...
export const MillionaireSection = (callback, deps) => {
  ...
  const buildSavingsPoints = useCallback(() => {
    ...
    return o
  }, [currentYear, periodYears, monthlySavings])
  ...
  const buildCompoundSavingsPoints = useCallback(() => {
    ...
    for (let years = 1; years <= periodYears; years++) {
      o.data.push({
        x: currentYear + years,
        y: ((1 + annualReturn)**years) * monthlySalary * 12 * monthlySavings * years
      })
    }
    return o
  ...
  }, [periodYears, monthlySalary, monthlySavings, annualReturn])
      ...
      <div className="col-sm-6 mb-4">
        <form>
          ...
          <div className="form-group">
            ...
            <select id="monthlySavings" style={{width: 200}} aria-describedby="monthlySavingsHelp" className="form-control" className="form-control" value={monthlySavings} onChange={event => setMonthlySavings(event.target.value)}>
          ...
          <div className="form-group">
            ...
            <select id="annualReturn" style={{width: 200}} aria-describedby="annualReturnHelp" className="form-control" className="form-control" value={annualReturn} onChange={event => setAnnualReturn(parseFloat(event.target.value))}>
